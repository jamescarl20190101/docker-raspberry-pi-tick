...
# InfluxDB
sudo mkdir -p /clusterfs/influxdb/etc/influxdb
cp -n influxdb.conf /clusterfs/influxdb/etc/influxdb/influxdb.conf
sudo mkdir -p /clusterfs/influxdb/var/lib/influxdb/meta
sudo mkdir -p /clusterfs/influxdb/var/lib/influxdb/data
chmod -R a+rw /clusterfs/influxdb
